...
export default function Notification({ message, status, icon, notificationToggle }: Props) {
    ...
    return (
        ...
        className=' w-[22rem] h-[5rem] sm:w-[28rem] sm:h-[4rem] flex flex-row z-30 absolute top-[260rem] left-1 sm:top-[255rem] md:top-[195rem] lg:top-[180rem] sm:left-5 px-5 shadow-lg'
        >
            ...
            <MdClear onClick={() => notificationToggle(false)} className='text-gray-700 absolute top-7 right-7 text-xl cursor-pointer hover:bg-slate-200 rounded-full' />
