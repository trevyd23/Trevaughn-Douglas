...
export const Card = ({ appImage, appLink, appName, appDescription }: PortfolioApplication) => {
  return (<>
    <div className='w-[35rem] h-[35rem] bg-[#201f1f] rounded-xl m-6 flex-col items-center px-5 hidden md:flex'>
    ...
    <div className='w-[30rem] h-[55rem] bg-[#201f1f] rounded-xl m-6 flex flex-col items-center px-5 md:hidden'>
      <span className='text-3xl mt-4'>{appName}</span>
